...
with tf.Graph().as_default():
    ...
    en_sentences = ["What' s your name", 'My name is', 'What are you doing', 'I am reading a book',                    'How are you', 'I am good', 'Do you speak English', 'What time is it', 'Hi', 'Goodbye', 'Yes', 'No']
