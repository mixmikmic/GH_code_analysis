...
get_ipython().magic("time process_video('solidWhiteRight.mp4', 'white.mp4')")

get_ipython().magic("time process_video('solidYellowLeft.mp4', 'yellow.mp4')")

get_ipython().magic("time process_video('challenge.mp4', 'extra.mp4')")
