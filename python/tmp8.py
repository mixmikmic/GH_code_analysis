...
def fetch_image(url):
    ...
    with open('./data/image_8.jpg', 'wb') as out_file:
...
for idx in range(800000, 900000):
    url = urls[idx]
    # Check if already downloaded
    if os.path.exists('./data/tmp8/' + str(idx) + '.jpg'):
        continue
        
    # Get image from url
    fetch_image(url)
    os.rename('./data/image_8.jpg', './data/tmp8/'+ str(idx) + '.jpg')
