...
get_ipython().system('pip install cli-pipeline==1.3.0')

get_ipython().system('rm -rf ./runs')

get_ipython().system('rm -rf ./runs/')

get_ipython().system('pipeline _cluster_deploy_tar --deploy-server-url=http://admin.community.pipeline.ai --model-type=tensorflow --model-name=mnist --model-tag=test --model-path=.')
