...
get_ipython().run_line_magic('time', 'pclip1.write_videofile(output1, audio=False)')
get_ipython().run_line_magic('time', 'pclip2.write_videofile(output2, audio=False)')
get_ipython().run_line_magic('time', 'pclip3.write_videofile(output3, audio=False)')
...
HTML("""
<h1>solidWhiteRight.mp4</h1><video width="960" height="540" controls>
<source src="{0}">
</video>
""".format(output2))

HTML("""
<h1>challenge.mp4</h1><video width="960" height="540" controls>
<source src="{0}">
</video>
""".format(output3))
