...
data_df_short_test = data_df[0:100]
data_df_short_test

data_df_short_test = data_df[0:10000]
data_df_short_test
...
VegaLite({
  "mark": "point",
  "encoding": {
    "y": {"type": "quantitative","field": "GR"},
    "x": {"type": "quantitative","field": "ILD"}
  }
}, data_df_short_test)
...
#   "transform": [{"calculate": "hours(datum.date)", "as": "time"}],
  "repeat": {"column": ["GR", "ILD", "new_pick_paleoz"]},
  "spec": {
    "layer": [{
      "selection": {
...
# plot single tree
#plot_tree(modelC)
plot_tree(modelC, num_trees=2)
plt.show()

plot_tree2 = plot_tree(modelC, num_trees=60)

figTree2 = plot_tree2.figure
figTree2.set_size_inches(20, 200)

plot_tree20 = plot_tree(modelC, num_trees=20)

figTree20 = plot_tree20.figure
figTree20.set_size_inches(20, 200)

plot_tree30 = plot_tree(modelC, num_trees=17)
figTree30 = plot_tree30.figure
figTree30.set_size_inches(20, 100)
...
plot_tree = to_graphviz(model)
fig_tree = plot_tree.figure
...
from xgboost import to_graphviz
plot_graph = to_graphviz(model)
#plot_graph.render()
plot_graph
# figG = plot_graph.figure
# figG.set_size_inches(12, 20)
