...
def prefixZ(inputtext):
    # prefixes before z
    prefixZ = re.sub(r'\b(БЕ|В|ВО|И|НИ|РА|РО|ЧЕРЕ|ЧРЕ)З([ПФТСКЦШЩЧ])', r'\1с\2',                             re.sub(r'\b(Бе|В|Во|И|Ни|Ра|Ро|Чере|Чре)з([пфтскцшщч])', r'\1с\2' ,                            re.sub(r'\b(бе|в|во|и|ни|ра|ро|чере|чре)з([пфтскцшщч])', r'\1с\2', inputtext)))
    return prefixZ
...
inputstring = "irgendwasія чортъ, всеблаго: ІЭ краснаго КРАСНАГО красняго КРАСНЯГО какія    ІіѢѣѲѳѴѵ ея Ея бея цвѣтовъ безполезный, съ отраженіями звѣздъ въ спящей водѣ рѣки возсоденинение."
