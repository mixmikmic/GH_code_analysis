...
par_set = {'n_rows': 570, 'n_cols': 923}
par_set['center_point'] = 1.0 + 0.0*1j
par_set['theta'] = 0
par_set['zoom'] = 3/4
...
np.round(323 * (np.sqrt(5)-1)/2)

#                                        smaller -> view individual escape time sets -- "iconic" 
par_set = {'n_rows': 200, 'n_cols': 323}
