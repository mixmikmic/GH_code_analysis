...
# quadrotor_3d.draw(t_sim, x_sim, t_nominal=t, x_nominal=x_nominal, savefig=True, out_dir="data/10", out_file="00.mp4")
ipython_display_utils.get_inline_video("data/10/00.mp4")
...
quadrotor_3d.draw(t_sim, x_sim, t_nominal=t, x_nominal=x_nominal)
# quadrotor_3d.draw(t_sim, x_sim, t_nominal=t, x_nominal=x_nominal, savefig=True, out_dir="data/10", out_file="01.mp4")
ipython_display_utils.get_inline_video("data/10/01.mp4")
