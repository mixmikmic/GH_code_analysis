...
lmag_priuH=(Lpri_H-lleak_pri)*1e6
lleak_pri=Lpri_H*(k);
...
Rcore=(V1rms**2)/Pout;
print("Core resistance referred to primary is",Rcore,"in units of ohm");

from IPython.display import Image 
Image(filename='equivalent.jpg')
