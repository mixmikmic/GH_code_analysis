...
net2 = NeuralNet((784,100,10), QuadraticCost, ReluActivation, SigmoidActivation)
...
net2 = NeuralNet((784,100,10), CrossEntropyCost, ReluActivation, SigmoidActivation)
net2.initialize_variables()
learning_rate = 1
epochs = 61
reporting_rate = 20
...
net2 = NeuralNet((784,100,10), LogLikelihoodCost, ReluActivation, SoftmaxActivation)
net2.initialize_variables_normalized()
learning_rate = 0.0002
epochs = 61
reporting_rate = 20
lmda = 0.3
