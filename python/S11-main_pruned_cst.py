...
AR = pd.read_csv('../../beast/main/pruned_segments/discreteTraits/results/pruned_combined_10mBurnin_actualRates.csv', index_col=0, header=0).to_dict(orient='index')
BF = pd.read_csv('../../beast/main/pruned_segments/discreteTraits/results/pruned_combined_10mBurnin_bf.csv', index_col=0, header=0).to_dict(orient='index')
...
plt.savefig('../png/FigS11.png', dpi=300, bbox_inches='tight')
