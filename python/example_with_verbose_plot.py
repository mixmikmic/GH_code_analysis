...
#b_code='/Users/davidkramer/Documents/GitHub/delta-psi-py/delta_psi_py/test__init__.py'

#exec(open(b_code).read())
...
phenomena_sets=['plot_cum_LEF_singetO2']    
        

fig = plt.figure(num='Figure 4 in paper', figsize=(5,2), dpi=200) #make a figure
...
#exec(open('/Users/davidkramer/Dropbox/Data/DF_ECS/Dy_DF_sim_def/Dy_DF_sim_def/Dy_DF_sim_def_DMK_4.py').read())
...
fig = plt.figure(num='Figure 4 (extended version)', figsize=(5,7), dpi=200) #make a figure
plot_every_nth_point=1
plot_block(output_dict, fig, conditions_to_plot, where, phenomena_sets, plot_every_nth_point)
