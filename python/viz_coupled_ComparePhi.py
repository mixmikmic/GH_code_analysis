...
file_list = ["index_message_2016-4-6_phi1_dh3.log.csv", "index_message_2016-4-6_phi10_dh3.log.csv", "index_message_2016-4-7_phi100_dh3.log.csv"]
...
for i, df in enumerate(df_list):
    ...
    ts.name = file_list[i]
    ts.plot(figsize=(20, 10), legend=True, ax=ax, ylim=(-1, -0.4))
