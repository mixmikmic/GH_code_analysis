...
get_ipython().run_cell_magic('prun', '', 'sim_p.run(100)')
...
sim = pip.Pipe_Flow(deltaP = deltaP)
...
sim_cl = lb_cl.Pipe_Flow_PeriodicBC_VelocityInlet(lx=lx, ly=ly, dr=dr, dt=dt, omega=omega,
...
sim_NewBC_Inlet_cl = lb_cl.Pipe_Flow_PeriodicBC_VelocityInlet(two_d_local_size=two_d_local_size,
                        three_d_local_size=three_d_local_size)
sim_NewBC_Inlet_cl.run(100)
