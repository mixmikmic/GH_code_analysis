...
actualRates = pd.read_csv('../../beast/main/discreteTraits/results/discreteTraits_2016-10-25_actualRates.csv', index_col=0, header=0)
bayesFactors = pd.read_csv('../../beast/main/discreteTraits/results/discreteTraits_2016-10-25_bf.csv', index_col=0, header=0)
...
plt.tight_layout()
plt.savefig('../png/FigS4.png', dpi=300, bbox_inches='tight')
plt.show()
