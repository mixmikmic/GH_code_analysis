...
check = Kitti_util(frame=frame, velo_path=velo_path, camera_path=image_path,                    xml_path=xml_path, v2c_path=v2c_filepath, c2c_path=c2c_filepath)
...
def draw_3d_box(tracklet_, type_):
    ...
    type_c = { 'Car': 'b', 'Van': 'g', 'Truck': 'r', 'Pedestrian': 'c',           'Person (sitting)': 'm', 'Cyclist': 'y', 'Tram': 'k', 'Misc': 'w'}
...
type_c = { 'Car': (0, 0, 255), 'Van': (0, 255, 0), 'Truck': (255, 0, 0), 'Pedestrian': (0,255,255),       'Person (sitting)': (255, 0, 255), 'Cyclist': (255, 255, 0), 'Tram': (0, 0, 0), 'Misc': (255, 255, 255)}
