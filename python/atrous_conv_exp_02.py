...
output = time_series_anomaly(df.power.values, look_ahead=8, look_back=input_size, epochs=2)
pickle.dump(output, open('dump/exp02-simple.pkl', 'wb'))

def plot_timeseries_with_bound(df, val_col, bound_col, true_col, xTitle='', yTitle='',
                       title='', filename='exp_02.html'):
...
output = pickle.load(open('dump/exp_02.pkl', 'rb'))
