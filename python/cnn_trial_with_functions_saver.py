...
def train_cnn(key):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            model_name = key
            checkpoint_prefix = os.path.join(checkpoint_dir, model_name  + "_""model")
        ...
        # Save model weights for future use.
            ...
            feed_dict={cnn.input_x:x_dev, cnn.dropout_keep_prob: 1.0}
...
graph_meta_file = checkpoint_dir + '/' + 'hnk_model.meta'
...
with graph.as_default():
    with tf.Session() as sess:
      ...
      #new_saver = tf.train.import_meta_graph(checkpoint_dir/'hnk_model.meta')
        ...
        feed_dict = {input_x: x_dev, input_y: y_dev, dropout_keep_prob: 1.0}
        y_pred_proba, y_pred  = sess.run([pred_proba, predictions],feed_dict)
