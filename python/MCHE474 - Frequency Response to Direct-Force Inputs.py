...
wun = np.linspace(0, 10, 1000)          # Frequency range for freq response plot, 0-10 Omega with 1000 points in-between
w = np.linspace(0, 10, 1000)            # Frequency range for freq response plot, 0-10 Omega with 1000 points in-between
...
ax1.semilogx(wun, 20*np.log10(k*mag_normal_un), linewidth=2, label=r'$\zeta$ = 0.0')
ax1.semilogx(w, 20*np.log10(k*mag_normal_0p1), linewidth=2, linestyle = '-.', label=r'$\zeta$ = 0.1')
ax1.semilogx(w, 20*np.log10(k*mag_normal_0p2), linewidth=2, linestyle = ':', label=r'$\zeta$ = 0.2')
ax1.semilogx(w, 20*np.log10(k*mag_normal_0p4), linewidth=2, linestyle = '--',label=r'$\zeta$ = 0.4')
# ax1.set_ylim(0.0,7.0)
...
ax2.semilogx(wun, phase_un, linewidth=2, label=r'$\zeta$ = 0.0')
ax2.semilogx(w, phase_0p1, linewidth=2, linestyle = '-.', label=r'$\zeta$ = 0.1')
ax2.semilogx(w, phase_0p2, linewidth=2, linestyle = ':', label=r'$\zeta$ = 0.2')
ax2.semilogx(w, phase_0p4, linewidth=2, linestyle = '--', label=r'$\zeta$ = 0.4')
ax2.set_ylim(-200.0,20.0,)
ax2.set_yticks([0, -90, -180])
