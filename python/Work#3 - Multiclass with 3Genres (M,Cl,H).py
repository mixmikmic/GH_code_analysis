...
data_set=pandas.concat((data_set[600:700],data_set[100:200],data_set[400:500]),ignore_index=True)
GENRES=config.Genre3.GENRE_NAMES
...
train, test = train_test_split(data_set_values, test_size = config.Genre3.TEST_SIZE,random_state=1,
...
neural=MLPClassifier(random_state=42,hidden_layer_sizes=[25,25])
