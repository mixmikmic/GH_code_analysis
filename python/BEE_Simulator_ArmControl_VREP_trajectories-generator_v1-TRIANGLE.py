...
sim_set = "triangle" # basically is the name of the folder where the data is read/saved
base_dir = "BaxterArm_VREP_simulation_data"

# The triangle uses three straight lines where each line spends 1/3 of the total time of 2s
time_step=2E-3
MT=time_step*(1000/3.0)
t_mov=numpy.arange(0, time_step*(1000/3.0), time_step) # t starts in 0s and steps time_step(s) until reaches MT(s)

# Triangle
trajectories = [[[-0.5,-0.5],[0.5,-0.5]],                [[0.5,-0.5],[0,0.5]],                [[0,0.5],[-0.5,-0.5]]]
...
#     print (xstart,ystart),(xdest,ydest)
#     print "Translated to table coordinates:\n",(XY_movement[0,0],XY_movement[0,1]),(XY_movement[-1,0],XY_movement[-1,1])
