...
query = 'READ "../data/auto-mpg.csv" (separator = "\s+", header = None) AND REPLACE ("?", "mode") AND SPLIT (train = .8, test = .2, validation = .0) AND  REGRESS (predictors = [2,3,4,5,6,7,8], label = 1, algorithm = simple) AND SAVE "auto.sml"'
