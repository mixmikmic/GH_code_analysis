...
def fade_in_unlabeled_exponential_loss(y_true, y_pred):
    return beta * keras.losses.categorical_crossentropy(y_true, y_pred)         + alpha * unlabeled_exponential_loss(y_true, y_pred)

optimizer = keras.optimizers.Adam(3.16228e-4)
