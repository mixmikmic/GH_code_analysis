        ...
        for e in range(model.epoch_pointer.eval(), num_epochs):
            ...
            for b in range(pointer, num_batches):
                ...
                if (e * num_batches + b) % batch_size == 0:
                    print("{}/{} (epoch {}), train_loss = {:.3f}, time/batch = {:.3f}"                         .format(e * num_batches + b,
                                num_epochs * num_batches,
                                e, train_loss, speed))
                
                #save model:
                if (e * num_batches + b) % save_every == 0                         or (e==num_epochs-1 and b == num_batches-1): # save for the last result
