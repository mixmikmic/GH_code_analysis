...
X_train, X_valid, X_test = X[:55000].reshape((-1, 1, 28, 28)),                           X[55000:60000].reshape((-1, 1, 28, 28)),                           X[60000:].reshape((-1, 1, 28, 28))
...
total_num = 0
for i in range(total_batch):
    num_valid = batch_size if (i + 1) * batch_size <= X_test.shape[0]                           else X_test.shape[0] - i * batch_size
