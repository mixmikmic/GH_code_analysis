...
sdfl_per_1e6_peri= galpy.df.streamgapdf(sigv/V0,progenitor=prog_unp_peri,pot=lp,aA=aAI,
                                        leading=False,nTrackChunks=26,nTrackIterations=1,
                                        sigMeanOffset=4.5,
                                        tdisrupt=10.88/bovy_conversion.time_in_Gyr(V0,R0),
                                        Vnorm=V0,Rnorm=R0,
...
figsize(8,6)
sdfl_per_1e6_peri.plotCompareTrackAAModel()
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,1]*V0,
     'r-',lw=2.)
subplot(2,3,2)
bovy_plot.bovy_plot(RvR_unp_impact[:,0],RvR_unp_impact[:,2],'k,',xlabel=r'$R\,(\mathrm{kpc})$',
                    ylabel=r'$v_T\,(\mathrm{km\,s}^{-1})$',gcf=True)
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,2]*V0,
     'r-',lw=2.)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,3]*R0,
     'r-',lw=2.)
subplot(2,3,4)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,4]*V0,
     'r-',lw=2.)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrack[:,5],
     'r-',lw=2.)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,1]*R0,
     'r-',lw=2.)
subplot(2,3,2)
bovy_plot.bovy_plot(xv_unp_impact[:,0],xv_unp_impact[:,2],'k,',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$Z\,(\mathrm{kpc})$',gcf=True)
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,2]*R0,
     'r-',lw=2.)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,3]*V0,
     'r-',lw=2.)
subplot(2,3,4)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,4]*V0,
     'r-',lw=2.)
subplot(2,3,5)
...
plot(sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,0]*R0,sdfl_per_1e6_peri._kick_interpolatedObsTrackXY[:,5]*V0,
     'r-',lw=2.)
tight_layout()

figsize(12,12)
subplot(2,2,1)
bovy_plot.bovy_plot(sdfl_per_1e6_peri._kick_interpolatedThetasTrack-sdfl_per_1e6_peri._impact_angle,
                    sdfl_per_1e6_peri._kick_deltav*V0,'-',lw=2.,
                    xlabel=r'$\Delta \theta_\parallel$',ylabel=r'$\Delta v$',
                    yrange=[-2.,2.],gcf=True)
subplot(2,2,2)
bovy_plot.bovy_plot(sdfl_per_1e6_peri._kick_interpolatedThetasTrack-sdfl_per_1e6_peri._impact_angle,
                    sdfl_per_1e6_peri._kick_dOap[:,3:],'-',lw=2.,
                    xlabel=r'$\Delta \theta_\parallel$',ylabel=r'$\Delta \theta$',
                    yrange=[-0.004,0.004],gcf=True)
subplot(2,2,3)
bovy_plot.bovy_plot(sdfl_per_1e6_peri._kick_interpolatedThetasTrack-sdfl_per_1e6_peri._impact_angle,
                    sdfl_per_1e6_peri._kick_dOap[:,:3]*bovy_conversion.freq_in_Gyr(V0,R0),'-',lw=2.,
                    xlabel=r'$\Delta \theta_\parallel$',ylabel=r'$\Delta \Omega\,(\mathrm{Gyr}^{-1})$',
                    yrange=[-0.15,0.15],gcf=True)
subplot(2,2,4)
bovy_plot.bovy_plot(sdfl_per_1e6_peri._kick_interpolatedThetasTrack-sdfl_per_1e6_peri._impact_angle,
                    sdfl_per_1e6_peri._kick_dOaparperp*bovy_conversion.freq_in_Gyr(V0,R0),'-',lw=2.,
                    xlabel=r'$\Delta \theta_\parallel$',ylabel=r'$\Delta \Omega_{\parallel,\perp}\,(\mathrm{Gyr}^{-1})$',
                    yrange=[-0.15,0.15],gcf=True)
#bovy_plot.bovy_plot(sdfl_per_1e6_peri._kick_interpolatedThetasTrack+sdfl_per_1e6_peri._impact_angle,
#                    sdfl_per_1e6_peri._kick_interpdOpar(sdfl_per_1e6_peri._kick_interpolatedThetasTrack)*bovy_conversion.freq_in_Gyr(V0,R0),'-',lw=2.,
#                    overplot=True)
...
bovy_plot.bovy_plot(xs,
                    [sdfl_per_1e6_peri._rewind_angle_impact(x) for x in xs],
                    '-',lw=2.,gcf=True,
                    xlabel=r'$\Delta \theta_\parallel$',ylabel=r'$\Delta \theta_\parallel^\mathrm{impact}$')
subplot(1,2,2)
bovy_plot.bovy_plot(xs,
                    [sdfl_per_1e6_peri._rewind_angle_impact(x)+sdfl_per_1e6_peri._meandO*sdfl_per_1e6_peri._timpact*sdfl_per_1e6_peri._sigMeanSign-x for x in xs],
                    '-',lw=2.,gcf=True,
...
figsize(16,8)
subplot(2,3,1)
bovy_plot.bovy_plot(xv_1e6_peri[:,0],xv_1e6_peri[:,1],'k,',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$Y\,(\mathrm{kpc})$',gcf=True,
                    xrange=[-5.,15.])
...
sdfl_per_1e6_peri.plotTrack(d1='X',d2='Y',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,2)
bovy_plot.bovy_plot(xv_1e6_peri[:,0],xv_1e6_peri[:,2],'k,',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$Z\,(\mathrm{kpc})$',gcf=True,
                    xrange=[-5.,15.])
...
sdfl_per_1e6_peri.plotTrack(d1='X',d2='Z',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,3)
bovy_plot.bovy_plot(xv_1e6_peri[:,0],xv_1e6_peri[:,3],'k,',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$v_X\,(\mathrm{km\,s}^{-1})$',gcf=True,
                    xrange=[-5.,15.])
...
sdfl_per_1e6_peri.plotTrack(d1='X',d2='vX',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,4)
bovy_plot.bovy_plot(xv_1e6_peri[:,0],xv_1e6_peri[:,4],'k,',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$v_Y\,(\mathrm{km\,s}^{-1})$',gcf=True,
                    xrange=[-5.,15.])
...
sdfl_per_1e6_peri.plotTrack(d1='X',d2='vY',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,5)
bovy_plot.bovy_plot(xv_1e6_peri[:,0],xv_1e6_peri[:,5],'k,',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$v_Z\,(\mathrm{km\,s}^{-1})$',gcf=True,
                    xrange=[-5.,15.])
...
sdfl_per_1e6_peri.plotTrack(d1='X',d2='vZ',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
tight_layout()

figsize(16,8)
subplot(2,3,1)
bovy_plot.bovy_plot(RvR_1e6_peri[:,0],RvR_1e6_peri[:,1],'k,',xlabel=r'$R\,(\mathrm{kpc})$',
                    ylabel=r'$v_R\,(\mathrm{km\,s}^{-1})$',gcf=True,
                    xrange=[11.,14.])
...
sdfl_per_1e6_peri.plotTrack(d1='R',d2='vR',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,2)
bovy_plot.bovy_plot(RvR_1e6_peri[:,0],RvR_1e6_peri[:,2],'k,',xlabel=r'$R\,(\mathrm{kpc})$',
                    ylabel=r'$v_T\,(\mathrm{km\,s}^{-1})$',gcf=True,
                    xrange=[11.,14.])
sdfl_unp_peri.plotTrack(d1='R',d2='vT',interp=True,color='b',spread=2,overplot=True,lw=2.,scaleToPhysical=True)
sdfl_per_1e6_peri.plotTrack(d1='R',d2='vT',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,3)
bovy_plot.bovy_plot(RvR_1e6_peri[:,0],RvR_1e6_peri[:,3],'k,',xlabel=r'$R\,(\mathrm{kpc})$',
                    ylabel=r'$Z\,(\mathrm{kpc})$',gcf=True,
                    xrange=[11.,14.])
sdfl_unp_peri.plotTrack(d1='R',d2='Z',interp=True,color='b',spread=2,overplot=True,lw=2.,scaleToPhysical=True)
sdfl_per_1e6_peri.plotTrack(d1='R',d2='Z',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,4)
bovy_plot.bovy_plot(RvR_1e6_peri[:,0],RvR_1e6_peri[:,4],'k,',xlabel=r'$R\,(\mathrm{kpc})$',
                    ylabel=r'$v_Z\,(\mathrm{km\,s}^{-1})$',gcf=True,
                    xrange=[11.,14.])
sdfl_unp_peri.plotTrack(d1='R',d2='vZ',interp=True,color='b',spread=2,overplot=True,lw=2.,scaleToPhysical=True)
sdfl_per_1e6_peri.plotTrack(d1='R',d2='vZ',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
subplot(2,3,5)
bovy_plot.bovy_plot(RvR_1e6_peri[:,0],RvR_1e6_peri[:,5],'k,',xlabel=r'$R\,(\mathrm{kpc})$',
                    ylabel=r'$\phi$',gcf=True,
                    xrange=[11.,14.])
sdfl_unp_peri.plotTrack(d1='R',d2='phi',interp=True,color='b',spread=2,overplot=True,lw=2.,scaleToPhysical=True)
sdfl_per_1e6_peri.plotTrack(d1='R',d2='phi',interp=True,color='r',spread=0,overplot=True,lw=2.,scaleToPhysical=True)
tight_layout()

xrange=[-5.,15.]
numpy.random.seed(1)
xv_mock_per= sdfl_per_1e6_peri.sample(n=100000,xy=True).T
...
raw= bovy_plot.bovy_hist(xv_1e6_peri[xv_1e6_peri[:,1] < 5.,0],bins=101,fc='0.5',ec='r',normed=True,histtype='step',
...
b,e= numpy.histogram(xv_1e6_peri[xv_1e6_peri[:,1] < 5.,0],bins=101,normed=True,range=xrange)
t= ((numpy.roll(e,1)-e)/2.+e)[1:]
lspl= interpolate.UnivariateSpline(t,numpy.log(b),k=3,s=1.)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    (sdfl_per_1e6_peri._ObsTrackXY[:,1]-sdfl_unp_peri._ObsTrackXY[:,1])*R0,
                    'b-',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$\Delta Y\,(\mathrm{kpc})$',gcf=True,yrange=[-2.,2.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),1]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),1],'k,')
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,1]-xv_mock_unp[:,1])*R0,'r,')
subplot(2,3,2)
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    (sdfl_per_1e6_peri._ObsTrackXY[:,2]-sdfl_unp_peri._ObsTrackXY[:,2])*R0,
                    'b-',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$\Delta Z\,(\mathrm{kpc})$',gcf=True,yrange=[-2.,2.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),2]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),2],'k,')
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,2]-xv_mock_unp[:,2])*R0,'r,')
subplot(2,3,4)
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    (sdfl_per_1e6_peri._ObsTrackXY[:,3]-sdfl_unp_peri._ObsTrackXY[:,3])*V0,
                    'b-',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$\Delta v_X\,(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[-20.,20.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),3]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),3],'k,')
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,3]-xv_mock_unp[:,3])*V0,'r,')
subplot(2,3,5)
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    (sdfl_per_1e6_peri._ObsTrackXY[:,4]-sdfl_unp_peri._ObsTrackXY[:,4])*V0,
                    'b-',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$\Delta v_Y\,(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[-20.,20.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),4]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),4],'k,')
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,4]-xv_mock_unp[:,4])*V0,'r,')
subplot(2,3,6)
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    (sdfl_per_1e6_peri._ObsTrackXY[:,5]-sdfl_unp_peri._ObsTrackXY[:,5])*V0,
                    'b-',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$\Delta v_Z\,(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[-20.,20.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),5]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),5],'k,')
...
plot(xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),1],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),2],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],
     'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$\delta y/\mathrm{kpc}$',gcf=True,yrange=[-2.,2.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),1]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),1],
     'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),3],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),4],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),5],'k.',ms=1,alpha=0.3)
...
sdfl_unp_peri= custom_stripping_df.streamdf_jason(sigv/V0,progenitor=prog_unp_peri,pot=lp,aA=aAI,
                        ...
                        tdisrupt=10.88/bovy_conversion.time_in_Gyr(V0,R0),
                        Vnorm=V0,Rnorm=R0)
sdfl_per_1e6_peri= custom_stripping_df.streamgapdf_jason(sigv/V0,progenitor=prog_unp_peri,pot=lp,aA=aAI,
                                                        leading=False,nTrackChunks=101,nTrackIterations=1,
...
subplot(2,3,1)
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    (sdfl_per_1e6_peri._ObsTrackXY[:,0]-sdfl_unp_peri._ObsTrackXY[:,0])*R0,
                    'b-',xlabel=r'$X\,(\mathrm{kpc})$',
                    ylabel=r'$\Delta X\,(\mathrm{kpc})$',gcf=True,yrange=[-2.,2.],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],'k,')
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$Y\,(\mathrm{kpc})$',gcf=True,yrange=[-13.,-6.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),1],'k,')
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$Z\,(\mathrm{kpc})$',gcf=True,yrange=[-6.,10.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),2],'k,')
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),3],'k,')
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$\Delta v_Y\,(\mathrm{km\,s}^{-1})$',gcf=True,#yrange=[-20.,20.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),4],'k,')
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                   ...
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),5],'k,')
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$y/\mathrm{kpc}$',gcf=True,yrange=[-13.,-6.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),1],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$z/\mathrm{kpc}$',gcf=True,yrange=[-6.,10.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),2],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    sdfl_unp_peri._ObsTrackXY[:,0]*R0*0.,
                    '-',xlabel=r'$x/\mathrm{kpc}$',color=sns.color_palette()[0],
                    ylabel=r'$\delta x/\mathrm{kpc}$',gcf=True,yrange=[-.15,.15],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),0]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],
     'k.',ms=1,alpha=0.3)
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,0]-xv_mock_unp[:,0])*R0,'.',color=sns.color_palette()[2],ms=1.5,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    sdfl_unp_peri._ObsTrackXY[:,0]*R0*0.,
                    '-',xlabel=r'$x/\mathrm{kpc}$',color=sns.color_palette()[0],
                    ylabel=r'$\delta y/\mathrm{kpc}$',gcf=True,yrange=[-.05,.05],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),1]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),1],
     'k.',ms=1,alpha=0.3)
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,1]-xv_mock_unp[:,1])*R0,'.',color=sns.color_palette()[2],ms=1.5,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    sdfl_unp_peri._ObsTrackXY[:,0]*R0*0.,
                    '-',xlabel=r'$x/\mathrm{kpc}$',color=sns.color_palette()[0],
                    ylabel=r'$\delta z/\mathrm{kpc}$',gcf=True,yrange=[-.15,.15],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),2]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),2],
     'k.',ms=1,alpha=0.3)
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,2]-xv_mock_unp[:,2])*R0,'.',color=sns.color_palette()[2],ms=1.5,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$v_x/(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[120.,270.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),3],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$v_y/(\mathrm{km\,s}^{-1})$',gcf=True,#yrange=[-20.,20.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),4],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    ...
                    ylabel=r'$v_z/(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[-200.,-100.],
                   xrange=[-5.,15.],zorder=10,lw=2.)
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),5],'k.',ms=1,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    sdfl_unp_peri._ObsTrackXY[:,0]*R0*0.,
                    '-',xlabel=r'$x/\mathrm{kpc}$',color=sns.color_palette()[0],
                    ylabel=r'$\delta v_x/(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[-.75,.75],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),3]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),3],
     'k.',ms=1,alpha=0.3)
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,3]-xv_mock_unp[:,3])*V0,'.',color=sns.color_palette()[2],ms=1.5,alpha=0.3)
...
bovy_plot.bovy_plot(sdfl_unp_peri._ObsTrackXY[:,0]*R0,
                    sdfl_unp_peri._ObsTrackXY[:,0]*R0*0.,
                    '-',xlabel=r'$x/\mathrm{kpc}$',color=sns.color_palette()[0],
                    ylabel=r'$\delta v_z/(\mathrm{km\,s}^{-1})$',gcf=True,yrange=[-.75,.75],
                   xrange=[-5.,15.])
plot(xv_unp_peri[(xv_unp_peri[:,1] < 5.),0],xv_1e6_peri[(xv_unp_peri[:,1] < 5.),5]-xv_unp_peri[(xv_unp_peri[:,1] < 5.),5],
     'k.',ms=1,alpha=0.3)
plot(xv_mock_unp[:,0]*R0,(xv_mock_per[:,5]-xv_mock_unp[:,5])*V0,'.',color=sns.color_palette()[2],ms=1.5,alpha=0.3)
...
line1= bovy_plot.bovy_hist(xv_unp_peri[xv_unp_peri[:,1] < 5.,0],bins=bins,fc='0.5',ec=None,normed=True,histtype='stepfilled',
                         yrange=[0.,0.1],range=xrange,xlabel=r'$x/\mathrm{kpc}$')
line2= bovy_plot.bovy_hist(xv_1e6_peri[xv_1e6_peri[:,1] < 5.,0],bins=bins,fc='0.5',ec='k',
