...
file_list = ["index_message_2016-6-1_2232.log.csv", "index_message_2016-6-1_2300.log.csv", "index_message_2016-6-1_2330.log.csv", "index_message_2016-6-1_2400.log.csv"]
...
for i, df in enumerate(df_list):
    ...
    ts.name = file_list[i]
    ts.plot(figsize=(20, 10), legend=True, ax=ax, ylim=(-2, -0.4))

df_list[2].req_generated.mean()
