...
# load dataset
dataset = read_csv('../../clean_data/Model_Sherry/waveform_anno.csv', header=0, index_col=0)
dataset
...
column_list = [0,1]
padded_columns = [(i + window_size*3) for i in column_list]
