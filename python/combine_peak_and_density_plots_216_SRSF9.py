...
density_included = os.path.join(
    density_dir, '216_01_SRSF9.merged.r2.1.SRSF9-BGHLV12-HepG2-included-upon-knockdown.normed_matrix.txt'
)
density_excluded = os.path.join(
    density_dir, '216_01_SRSF9.merged.r2.1.SRSF9-BGHLV12-HepG2-excluded-upon-knockdown.normed_matrix.txt'
)
density_native_cass = os.path.join(
    density_dir, '216_01_SRSF9.merged.r2.1.HepG2_native_cassette_exons.normed_matrix.txt'
)

excl_peak_pvalue = '/projects/ps-yeolab3/bay001/maps/current/se_peak/216_01.basedon_216_01.peaks.l2inputnormnew.bed.compressed.Excluded_upon_knockdown_(216_events).pvalue'
incl_peak_pvalue = '/projects/ps-yeolab3/bay001/maps/current/se_peak/216_01.basedon_216_01.peaks.l2inputnormnew.bed.compressed.Included_upon_knockdown_(264_events).pvalue'

excl_read_pvalue = '/projects/ps-yeolab3/bay001/maps/current/se/216_01_SRSF9.merged.r2.1.SRSF9-BGHLV12-HepG2-excluded-upon-knockdown.pvalues.txt'
incl_read_pvalue = '/projects/ps-yeolab3/bay001/maps/current/se/216_01_SRSF9.merged.r2.1.SRSF9-BGHLV12-HepG2-included-upon-knockdown.pvalues.txt'

output_file = '/home/bay001/projects/gabe_qc_20170612/analysis/216_01_SRSF9_peak_vs_density_with_pvalue_heatmaps_as_hist.svg'
...
peak_bed = os.path.join(peak_dir, '216_01.basedon_216_01.peaks.l2inputnormnew.bed.compressed.bed')
peak_included_annotation = os.path.join(peak_annotation_dir, 'SRSF9-BGHLV12-HepG2-included-upon-knockdown')
peak_excluded_annotation = os.path.join(peak_annotation_dir, 'SRSF9-BGHLV12-HepG2-excluded-upon-knockdown')
...
density_bg = dline.LineObject(
    event_matrix=pd.read_table(density_native_cass, sep=',', index_col=0),
    annotation='Native cassette exons',
    conf=0.95,
    color='black', # reddish
    min_event_threshold=10000 # change 11/27
)
...
output_file = '/home/bay001/projects/gabe_qc_20170612/analysis/216_01_SRSF9_peak_vs_density_with_pvalue_heatmaps_as_hist.excl_on_kd.svg'
fig.savefig(output_file)
...
density_plotter = Plotter._SEPlotter(lines=[density_excl, density_bg], num_regions=4)
read_map_regions = density_plotter.plot(read_map_regions, None)
...
leg = read_map_regions[0].legend(
    bbox_to_anchor=(2.5, -1.3), loc=1, mode="expand",
    handles=[excl_density_patch],
    borderaxespad=0., ncol=2, fontsize=FONTSIZE
)


output_file = '/home/bay001/projects/gabe_qc_20170612/analysis/216_01_SRSF9_peak_vs_density_with_pvalue_heatmaps_as_hist.excl_on_kd.read_only.svg'
fig.savefig(output_file)
...
output_file = '/home/bay001/projects/gabe_qc_20170612/analysis/216_01_SRSF9_peak_vs_density_with_pvalue_heatmaps_as_hist.excl_on_kd.peak_only.svg'
fig.savefig(output_file)
