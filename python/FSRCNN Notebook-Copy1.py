...
#load training
data_x = FSRCNN_Theano2.load_dataset('/home/ubuntu/Data/Training_Subsamples_RGB_4','data_x')
data_y = FSRCNN_Theano2.load_dataset('/home/ubuntu/Data/Training_Subsamples_RGB_4_gt','data_y')
valid_x = FSRCNN_Theano2.load_dataset('/home/ubuntu/Data/Validation_Subsamples_RGB_4','data_x')
valid_y = FSRCNN_Theano2.load_dataset('/home/ubuntu/Data/Validation_Subsamples_RGB_4_gt','data_y')
test_x = FSRCNN_Theano2.load_dataset('/home/ubuntu/Data/Test_Subsamples_RGB_4','data_x')
test_y = FSRCNN_Theano2.load_dataset('/home/ubuntu/Data/Test_Subsamples_RGB_4_gt','data_y')
print "done loading\n\n"
...
FSRCNN_Theano.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Validation_Subsamples_RGB_4/',patch_dim=16,dataset='validate_lr=5e4_batch=25_modelfull')
reconstructed_imgs = np.zeros((14851, 3, 16, 16))
for i in xrange(n_test_batches):
     cost,MSE_per_pixel,psnr,reconstucted_patches = test_model(i)
     reconstructed_imgs[i*batch_size:(i+1)*batch_size,:,:,:] = reconstucted_patches

FSRCNN_Theano.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Test_Subsamples_RGB_4/',patch_dim=16,dataset='test_lr=5e4_batch_25_modelfull')
...
FSRCNN_Theano.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Validation_Subsamples_RGB_4/',patch_dim=16,dataset='validate_lr=5e4_batch=25_modelfull', place=True)
reconstructed_imgs = np.zeros((14851, 3, 16, 16))
for i in xrange(n_test_batches):
     cost,MSE_per_pixel,psnr,reconstucted_patches = test_model(i)
     reconstructed_imgs[i*batch_size:(i+1)*batch_size,:,:,:] = reconstucted_patches

FSRCNN_Theano.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Test_Subsamples_RGB_4/',patch_dim=16,dataset='test_lr=5e4_batch=25_modelfull',place=True)
...
FSRCNN_Theano2.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Validation_Subsamples_RGB_4/',patch_dim=17,dataset='validate_lr=5e4_batch=25_modelfull')
reconstructed_imgs = np.zeros((14851, 3, 17, 17))
for i in xrange(n_test_batches):
     cost,MSE_per_pixel,psnr,reconstucted_patches = test_model(i)
     reconstructed_imgs[i*batch_size:(i+1)*batch_size,:,:,:] = reconstucted_patches

FSRCNN_Theano2.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Test_Subsamples_RGB_4/',patch_dim=17,dataset='test_lr=5e4_batch_25_modelfull')
...
FSRCNN_Theano2.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Validation_Subsamples_RGB_4/',patch_dim=17,dataset='validate_lr=5e4_batch=25_modelfull', place=True)
reconstructed_imgs = np.zeros((14851, 3, 17, 17))
for i in xrange(n_test_batches):
     cost,MSE_per_pixel,psnr,reconstucted_patches = test_model(i)
     reconstructed_imgs[i*batch_size:(i+1)*batch_size,:,:,:] = reconstucted_patches

FSRCNN_Theano2.rebuild_images(reconstructed_imgs,'/home/ubuntu/Data/Test_Subsamples_RGB_4/',patch_dim=17,dataset='test_lr=5e4_batch=25_modelfull',place=True)
