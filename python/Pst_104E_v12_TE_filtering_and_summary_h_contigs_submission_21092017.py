...
p_repet_summary_df = pd.read_csv(TE_post_analysis_p+'/'+'Pst79a_anno_chr_allTEs_nr_noSSR_join_path.annotStatsPerTE.tab' ,                                names = TE_post_analysis_p_header, header=None, sep='\t', skiprows=1 )
...
contigs_smaller_2000 = pd.read_csv('/home/benjamin/genome_assembly/PST79/FALCON/p_assemblies/v9_1/032017_assembly/hcontig_smaller_2000.txt',                                  header=None)[0].tolist()
