...
macro = pd.read_csv('../data/rent_3room_index.csv',header=None)
...
macro.columns = ['month_year','nominal_index']
...
df_sub.price_full.median()

# 0.32046
df_sub[['price_doc']].to_csv('../submissions/sub_XGB_0529_810PM.csv')
